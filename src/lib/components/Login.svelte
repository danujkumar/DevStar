<section class="absolute top-20 -z-40 h-screen w-screen bg-slate-50 md:top-0">
	<div class="h-full px-6 text-gray-800">
		...
		>
			<div class="shrink-1 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
				<img src="../../signup.webp" class="w-full" alt="Login" />
				<img src="../" alt="" srcset="" />
			</div>
			<div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:ml-20 xl:w-5/12">
				<form>
					...
					<div class="mb-6">
						<input
							type="text"
							class="m-0 block w-full rounded border border-solid border-gray-300 bg-white bg-clip-padding px-4 py-2 text-xl font-normal text-gray-700 transition ease-in-out focus:border-blue-600 focus:bg-white focus:text-gray-700 focus:outline-none"
					...
					<div class="mb-6 flex items-center justify-between">
						<div>
							<input
								type="checkbox"
								class=" float-left mt-1 mr-2 h-4 w-4 cursor-pointer appearance-none rounded-sm border border-gray-300 bg-white bg-contain bg-center bg-no-repeat align-top transition duration-200 checked:border-blue-600 checked:bg-blue-600 focus:outline-none"
							/>
							<label class=" inline-block text-gray-800" for="exampleCheck2">Remember me</label>
						</div>
